...
import 'package:infinite_scroll_pagination_v6/src/layouts/paged_sliver_aligned_grid.dart';
...
class PagedAlignedGridView<PageKeyType, ItemType> extends BoxScrollView {
  ...
  @override
  Widget buildChildLayout(BuildContext context) => PagedSliverAlignedGrid<PageKeyType, ItemType>(
